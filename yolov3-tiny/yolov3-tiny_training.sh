...
mkdir weights
cd weights
# yolov4-tiny pretrained weights for the convolutional layers
wget https://drive.google.com/file/d/18v36esoXCh-PsOKwyP2GWrpYDptDY8Zf/view?usp=sharing
cd ..
#cp yolov3-tiny.conv.11 weights/
...
mkdir cfg
cd cfg
wget https://raw.githubusercontent.com/newjoy2018/MA_YOLOv4/main/Downloads/cfg/yolov3-tiny.cfg
#cp ../yolov3-tiny.cfg ./
...
./darknet/darknet detector train cfg/obj.data cfg/yolov3-tiny.cfg weights/ weights/yolov3-tiny.conv.11 -dont_show | tee -a trainingLog/yolov3-tiny_TrainingLog.txt
